...
- |*6*| Registry Deep Dive | Navigate the Windows Registry to find hidden configuration keys (COMING SOON)...
- |*7*| Task Scheduler & Services | Investigate scheduled tasks and services to find malicious activity (COMING SOON)...
- |*8*| Event Log Forensics | Analyze Windows Event Logs to trace security incidents (COMING SOON)...
